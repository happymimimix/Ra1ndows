...
#pragma alloc_text (PAGE, VMCheckerEvtDeviceAdd)
#pragma alloc_text (PAGE, VMCheckerEvtDriverContextCleanup)
#endif
...
--*/
{
    ...
    attributes.EvtCleanupCallback = VMCheckerEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           VMCheckerEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = VMCheckerCreateDevice(DeviceInit);
...
VOID
VMCheckerEvtDriverContextCleanup(
